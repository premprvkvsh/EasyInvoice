...
//         <label className="text-base font-bold mt-4 block" htmlFor="currency">
//           Currency:
//         </label>
//         <select
//           onChange={(e) => {
...
//           }}
//           value={cntx.changeCurrency}
//           className="w-full text-center py-3 rounded-md shadow-md border-none bg-white transition duration-300 ease-in-out hover:bg-gray-200"
//           name="currency"
//           id="crc"
//         >
//           <option value="$">Dollar ($)</option>
...
//           <option value="₿">BTC (₿)</option>
//         </select>
//         <label className="text-base font-bold mt-4 block">Tax rate:</label>
//         <Cardone>
//           <PercentageSign />
//           <Input
//             className="w-full text-gray-600 py-2 px-6 text-base"
//             onChange={(e) => {
//               cntx.onSetTax(e.target.value);
//             }}
//             type="number"
...
//           />
//         </Cardone>
//         <label className="text-base font-bold mt-4 block">Discount rate:</label>
