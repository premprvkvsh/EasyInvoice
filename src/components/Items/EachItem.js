...
const EachItem = (props) => {
  ...
  return (
    <div className="flex items-center border-b border-black py-3 mb-2">
      <Input
      ...
      <Button
        ...
        className="ml-1 px-3 py-2 bg-red-600 text-white rounded-md border-none cursor-pointer transition-colors duration-300 ease-in-out hover:bg-red-700"
      >
        <FontAwesomeIcon icon={faTrashCan} />
      </Button>
    </div>
